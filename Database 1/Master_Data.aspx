                            ...
                            <tr>
                                <td>
                                    <p style="font-family: Trebuchet MS, Arial, Helvetica, sans-serif; color: #843C0C; font-size: 24px;">
                                        Territory:&nbsp
                                        <asp:DropDownList ID="drop_ter" runat="server" AutoPostBack="true" Font-Names="Trebuchet MS, Arial, Helvetica, sans-serif" Font-Size="20px" ForeColor="#843C0C"></asp:DropDownList>&nbsp
                                    </p>
                                </td>
                                <td>
                                    <p style="font-family: Trebuchet MS, Arial, Helvetica, sans-serif; color: #843C0C; font-size: 24px;">
                      ...
                      <asp:ListItem Text="Suggested" Value="Auto suggest"></asp:ListItem>
                                ...
                                <td>
                                    <p style="font-family: Trebuchet MS, Arial, Helvetica, sans-serif; font-size: 24px;">
                                        <asp:Button ID="btn_drop" runat="server" Text="Submit" BackColor="#843c0c" Font-Size="Medium" ForeColor="White" BorderColor="#843C0C" BorderStyle="None" Width="100px" Height="26px" />
                                    </p>
                                </td>
                    </td>
                </tr>
